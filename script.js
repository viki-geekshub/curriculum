...
<div id="caja_general">
    <a href="#">
        <div class="caja_proyecto">
            <img src="imagenes/proyecto.jpg" alt="Imagen de Proyecto" class="imagen_proyecto">
            <h3 class="titulo_proyecto">Proyecto Nº 1</h3>

        </div>
    </a>
    <a href="#">
        <div class="caja_proyecto">
            <img src="imagenes/proyecto2.png" alt="Imagen de Proyecto" class="imagen_proyecto">
            <h3 class="titulo_proyecto">Proyecto Nº 2</h3>

        </div>
    </a>
    <a href="#">
        <div class="caja_proyecto">
            <img src="imagenes/proyecto3.jpg" alt="Imagen de Proyecto" class="imagen_proyecto">
            <h3 class="titulo_proyecto">Proyecto Nº 3</h3>

        </div>
    </a>
    <a href="#">
        <div class="caja_proyecto">
            <img src="imagenes/proyecto4.jpg" alt="Imagen de Proyecto" class="imagen_proyecto">
            <h3 class="titulo_proyecto">Proyecto Nº 4</h3>

        </div>
    </a>
    <a href="#">
        <div class="caja_proyecto">
            <img src="imagenes/proyecto5.jpg" alt="Imagen de Proyecto" class="imagen_proyecto">
            <h3 class="titulo_proyecto">Proyecto Nº 5</h3>

        </div>
    </a>
    <a href="#">
        <div class="caja_proyecto">
            <img src="imagenes/proyecto6.jpg" alt="Imagen de Proyecto" class="imagen_proyecto">
            <h3 class="titulo_proyecto">Proyecto Nº 6</h3>

        </div>
    </a>
    <a href="#">
        <div class="caja_proyecto">
            <img src="imagenes/proyecto7.jpg" alt="Imagen de Proyecto" class="imagen_proyecto">
            <h3 class="titulo_proyecto">Proyecto Nº 7</h3>

        </div>
    </a>
    <a href="#">
        <div class="caja_proyecto">
            <img src="imagenes/proyecto8.jpg" alt="Imagen de Proyecto" class="imagen_proyecto">
            <h3 class="titulo_proyecto">Proyecto Nº 8</h3>

        </div>
    </a>
    <a href="#">
        <div class="caja_proyecto">
            <img src="imagenes/proyecto9.jpg" alt="Imagen de Proyecto" class="imagen_proyecto">
            <h3 class="titulo_proyecto">Proyecto Nº 9</h3>

        </div>
    </a>
</div>`;

const Formacion = `<h1 class="titulo_principal">FORMACIÓN</h1>
<div id="caja_general">
    <div class="estudio">   
        <div class="caja_año">
...
<div id="caja_general">
    <div class="estudio">
        ...
        <p class="titulo">Gestor Telefónico</p><br>
        <img src="imagenes/icono_escuela.png" alt="Icono de escuela" class="icono_escuela">
        <p class="escuela">Aqualia (Trainasa)</p>
        <p class="descripcion tabulacion">Atención telefónica en el departamento de Aqualia Contact,
            facilitando información, tramitando contratos de clientes y gestionando averías a nivel
            nacional.</p>
    </div>
    <div class="estudio">
        <div class="caja_año">
